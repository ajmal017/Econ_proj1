...
def prepare_market_indicator(index_price, Inx):
    ...
    ax.set_title('S&P Market chart', fontsize=20)
    ...
    ax2.set_xlabel('Last XX days', fontsize=20)
...
def bollinger_bands_graph(index_price, Inx):
    ...
    ax.plot(x_axis, boll_bands[Inx], color='blue', lw=2)
    ax.plot(x_axis, boll_bands['30 Day MA'], color='black', lw=2)
    # Set Title & Show the Image
    ax.set_title('Bollinger Bands for S&P Index')
...
def econometric_graph(combined_12_mo_return):
    ...
    plt.figure(1)
    fig, ax = plt.subplots(figsize=(18, 8))
    ax.set_title('Economic indicaters', fontsize=20)
    ax.set_ylabel('Annualized', fontsize=20)
    ax.set_xlabel('time', fontsize=20)
    fig.tight_layout()
    combined_12_mo_return['USSLIND'].plot(linewidth=3, color='green')
    combined_12_mo_return['MORTGAGE30US'].plot(linewidth=3, color='blue')
    combined_12_mo_return['CPILFESL'].plot(linewidth=3, color='black')
    combined_12_mo_return['T10Y2Y'].plot(linewidth=3, color='yellow')
    combined_12_mo_return['DTB3'].plot(linewidth=3, color='red')
    combined_12_mo_return['ICSA'].plot(linewidth=3, color='purple')
                        ...
                        combined_12_mo_return.loc[combined_12_mo_return.
                                                ...
                                                '.format(round(
                                                    ...
                                                    loc[combined_12_mo_return.
                                                        index[-1],
                                                        "ICSA"], 2)), ),
                        loc='upper left', shadow=False, fontsize=15)
